...
class PostServiceTest {
    ...
    void createAndFindPostTest() {
        ...
        // when
        PostResponse CreatedPsot = postService.createPost(createDto);
        PostResponse foundPost = postService.getPostById(CreatedPsot.id());

        // then
        assertThat(CreatedPsot.id()).isNotNull();
